                                                ...
                                                unsigned parameterListLength)
{
    ...
    unsigned strLen = (unsigned) strlen(str);

    // Replace every instance of delineator, \n, \r with 0
    for (unsigned strIndex = 0; strIndex < strLen; strIndex++)
    {
    ...
    unsigned parameterListIndex = 0;
    for (unsigned strIndex = 0; strIndex < strLen;)
    {
        if (str[strIndex] != 0)
        {
