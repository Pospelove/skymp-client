...
/// You can call GenerateTreeFromStrings to compress and decompress other languages efficiently as well.
    ...
    public:
        ...
        void EncodeString(const char *input, size_t maxCharsToWrite, RakNet::BitStream *output, uint8_t languageId = 0);
        ...
        /// \param[in] languageID Which language to use
        bool DecodeString(char *output, size_t maxCharsToWrite, RakNet::BitStream *input, uint8_t languageId = 0);
