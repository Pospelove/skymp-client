...
using namespace ShaderParticleGeometry;
...
using namespace ImageSpaceModifier;
...
using namespace ReferenceAlias;
...
using namespace ActiveMagicEffect;
...
namespace sd
{
	namespace Input
	{
		static void TapKey(int aiScanCode) {
			NativeInvoke::Invoke<ScriptNone>("Input", "TapKey", BSScript_StaticFunctionTag, aiScanCode);
		}
