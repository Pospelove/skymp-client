...
MyDirect3DDevice9::MyDirect3DDevice9(IDirect3DDevice9* pOriginal)
{
...
ULONG MyDirect3DDevice9::AddRef(void)
{
	return(m_pIDirect3DDevice9->AddRef());
}

ULONG MyDirect3DDevice9::Release(void)
{
...
HRESULT MyDirect3DDevice9::TestCooperativeLevel(void)
{
	return(m_pIDirect3DDevice9->TestCooperativeLevel());
}

UINT MyDirect3DDevice9::GetAvailableTextureMem(void)
{
	return(m_pIDirect3DDevice9->GetAvailableTextureMem());
}

HRESULT MyDirect3DDevice9::EvictManagedResources(void)
{
...
UINT    MyDirect3DDevice9::GetNumberOfSwapChains(void)
{
...
HRESULT MyDirect3DDevice9::BeginScene(void)
{
	return(m_pIDirect3DDevice9->BeginScene());
}

HRESULT MyDirect3DDevice9::EndScene(void)
{
...
HRESULT MyDirect3DDevice9::BeginStateBlock(void)
{
...
BOOL    MyDirect3DDevice9::GetSoftwareVertexProcessing(void)
{
...
float   MyDirect3DDevice9::GetNPatchMode(void)
{
...
HRESULT MyDirect3DDevice9::GetStreamSource(UINT StreamNumber, IDirect3DVertexBuffer9** ppStreamData, UINT* OffsetInBytes, UINT* pStride)
{
	return(m_pIDirect3DDevice9->GetStreamSource(StreamNumber, ppStreamData, OffsetInBytes, pStride));
}

HRESULT MyDirect3DDevice9::SetStreamSourceFreq(UINT StreamNumber, UINT Divider)
{
	return(m_pIDirect3DDevice9->SetStreamSourceFreq(StreamNumber, Divider));
}

HRESULT MyDirect3DDevice9::GetStreamSourceFreq(UINT StreamNumber, UINT* Divider)
{
...
HWND MyDirect3DDevice9::GetWindow()
{
...
HINSTANCE MyDirect3DDevice9::GetHinstance()
{
	return (HINSTANCE)GetWindowLong(GetWindow(), GWL_HINSTANCE);
}

IDirect3DDevice9 * MyDirect3DDevice9::GetDevice()
{
	return m_pIDirect3DDevice9;
}

RECT MyDirect3DDevice9::GetSize()
{
	RECT rect;
...
bool MyDirect3DDevice9::IsNullRenderer()
{
	return mNullRenderer;
}

void MyDirect3DDevice9::SetNullRenderer(bool pNullRenderer)
{
	mNullRenderer = pNullRenderer;
}

// This is our test function
void MyDirect3DDevice9::ShowWeAreHere(void)
{
